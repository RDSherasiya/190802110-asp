		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            ...
            <form id="form2" runat="server" class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input" data-validate = "Username is required">
                        <asp:TextBox ID="TextBox1" runat="server" class="input100" type="text" name="username"></asp:TextBox>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
                        <asp:TextBox ID="TextBox2" runat="server" class="input100" type="password" name="pass"></asp:TextBox>
						<span class="focus-input100"></span>
					</div>
